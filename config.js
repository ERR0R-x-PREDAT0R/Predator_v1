...
module.exports = {
    ...
    AFN: process.env.ALL_CAPTION === undefined ? 'Made By Predator_v1💞' : process.env.ALL_CAPTION,
    ...
    BOTPLK: process.env.BOT_NAME === undefined ? 'PREDATOR_V1' : process.env.BOT_NAME,
    SONGD: process.env.SONGD === undefined ? 'searching song🔎🎶' : process.env.SONGD,
    SONGU: process.env.SONGU === undefined ? 'uploading song 📲use🎧♥️' : process.env.SONGU,
    ...
    GIF_WEL: process.env.GIF_WEL === undefined ? 'https://imgur.com/8Js8lkD.mp4' : process.env.GIF_WEL,
    RASHI: process.env.LOGO_LINK === undefined ? 'https://imgur.com/cyXOi6o.jpeg' : process.env.LOGO_LINK,
    ...
    TAGPLK: process.env.TAG_HEADER === undefined ? 'Alinshan' : process.env.TAG_HEADER,
